...
namespace Products.UnitTests.Domain.Application.UnarchiveProductCommandTests
{
    public class UnArchiveItemCommandTests
    {
        ...
        public void ShouldCreateCommand_WhenValidProductIdProvided()
        {
            ...
            // Act
            var result = UnArchiveProductCommand.Create(validProductId);
        ...
        public void ShouldReturnError_WhenEmptyGuidProvided()
        {
            ...
            // Act
            var result = UnArchiveProductCommand.Create(emptyProductId);
        ...
        public void ShouldReturnError_WhenDefaultGuidProvided()
        {
            ...
            // Act
            var result = UnArchiveProductCommand.Create(defaultProductId);
        ...
        public void ShouldCreateCommand_WithVariousValidGuids(string guidString)
        {
            ...
            // Act
            var result = UnArchiveProductCommand.Create(productId);
        ...
        public void ShouldCreateDifferentCommands_ForDifferentProductIds()
        {
            ...
            // Act
            var firstResult = UnArchiveProductCommand.Create(firstProductId);
            var secondResult = UnArchiveProductCommand.Create(secondProductId);
